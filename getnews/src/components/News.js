...
export class News extends Component {
    ...
    constructor() {
     ...
     async updateNews(){
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1aea08ccff5446ce9dd715767eff7343&page=${this.state.page}&pageSize=${this.props.pageSize}`;
